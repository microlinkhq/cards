      ...
      >
        ...
        <Box
          sx={{
            ...
            height: '16px',
            borderRadius: '50%',
            background: 'linear-gradient(90deg, rgba(249,138,79,1) 0%, rgba(205,94,72,1) 100%)',
            top: '20%',
            left: '80%',
            filter: 'blur(0.5px)'
          }}
        ...
        <Box
          sx={{
            ...
            height: '42px',
            borderRadius: '50%',
            background: 'linear-gradient(45deg, rgba(243,187,117,1) 0%, rgba(205,95,71,1) 30%, rgba(168,69,64,1) 42%, rgba(156,67,67,1) 50%, rgba(120,62,77,1) 67%, rgba(55,48,60,1) 86%)',
            top: '30%',
            left: '86%',
            filter: 'blur(0.5px)',
            '::before': {
        ...
        <Box
          sx={{
            ...
            height: '440px',
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(251,225,173,1) 0%, rgba(245,178,122,1) 40%, rgba(231,121,87,1) 65%, rgba(243,114,65,0.8) 80%, rgba(249,43,35,0.6) 100%)',
        ...
        <Box sx={{ position: 'relative', width: '76%' }}>
          ...
          <Flex sx={{ alignItems: 'center' }}>
            ...
            <Box>
              <Box sx={{ pl: '2px' }}><Text sx={{ color: '#ffd6a7', textTransform: 'uppercase', fontSize: 14, letterSpacing: '1px', lineHeight: 1 }}>With</Text></Box>
              <Box><Text sx={{ color: '#fff', fontSize: 18, lineHeight: 1 }}>{query.author}</Text></Box>
            </Box>
          </Flex>
        </Box>
      </Box>
...
const query = {
  ...
  authorImages: ['https://unavatar.io/github/gaearon', 'https://unavatar.io/twitter/mappletons'],
